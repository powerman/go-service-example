...
func NewAddressBookAPI(spec *loads.Document) *AddressBookAPI {
	return &AddressBookAPI{
		...
		GetContactsHandler: GetContactsHandlerFunc(func(params GetContactsParams, principal *app.Auth) GetContactsResponder {
			// return middleware.NotImplemented("operation GetContacts has not yet been implemented")
			return GetContactsNotImplemented()
		}),
		PostContactsHandler: PostContactsHandlerFunc(func(params PostContactsParams, principal *app.Auth) PostContactsResponder {
			// return middleware.NotImplemented("operation PostContacts has not yet been implemented")
			return PostContactsNotImplemented()
		}),
...
type AddressBookAPI struct {
	...
	// GetContactsHandler sets the operation handler for the get contacts operation
	GetContactsHandler GetContactsHandler
	// PostContactsHandler sets the operation handler for the post contacts operation
	PostContactsHandler PostContactsHandler
...
func (o *AddressBookAPI) Validate() error {
	...
	if o.GetContactsHandler == nil {
		unregistered = append(unregistered, "GetContactsHandler")
	}

	if o.PostContactsHandler == nil {
		unregistered = append(unregistered, "PostContactsHandler")
	}
...
func (o *AddressBookAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/contacts"] = NewGetContacts(o.context, o.GetContactsHandler)

	if o.handlers["POST"] == nil {
		o.handlers["POST"] = make(map[string]http.Handler)
	}
	o.handlers["POST"]["/contacts"] = NewPostContacts(o.context, o.PostContactsHandler)
